...
Создала service account с названием egushchina-sa-lab1 и ролью Storage Admin
...
Создала виртуальную машину с названием  egushchina-vm-lab1 на основе упомянутого service account
...
Скопировала 3 файла из lab1-bucket-itmo в созданную виртуальную машину с помощью утилиты "gsutil" и проверила нахождение файлов на виртуальной машине с помощью команды ls -lah 
...
Сменила права доступа service account с Storage Admin на Compute Viewer
...
Как итог, В Google Cloud Storage существует разнообразие ролей, которые позволяют ограничивать и предоставлять доступ к бакетам или отдельным сервисам в облаке. 
